...
import { ArrowLeft, BarChart3, TrendingUp, Activity, CheckCircle } from "lucide-react"
...
export default function AnalyticsPage() {
  const features = [
    ...
    },
    {
      ...
      description: "Create custom metrics tailored to your business needs."
    },
    {
      icon: Activity,
      title: "Performance monitoring",
      description: "Track application performance and identify bottlenecks."
    },
    {
      icon: Activity,
      title: "Alerting system",
      description: "Get notified when issues arise with smart alerting."
    }
  ]
      ...
      <div className="relative z-10">
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-lg text-neutral-400 max-w-2xl mx-auto mb-8">
                Understand your application performance with real-time analytics and insights.
                Make data-driven decisions with comprehensive monitoring.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-neutral-400 max-w-2xl mx-auto">
                Powerful analytics tools to understand your application
              </p>
            </motion.div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              >
                ...
                <p className="text-neutral-400">
                  Why teams choose our analytics platform
                </p>
              </motion.div>
        ...
        <section className="pb-24">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-2xl font-bold text-white mb-4">Start Analyzing</h2>
              <p className="text-neutral-400 mb-6">
                Get real-time insights into your application performance.
              </p>
