...
import { ArrowLeft, Zap, Shield, BarChart3, Settings, CheckCircle } from "lucide-react"
  ...
  const features = [
    {
      icon: Zap,
      title: "Rate limiting",
      description: "Control API usage with flexible rate limiting and throttling."
    },
    {
      icon: Settings,
      title: "Request transformation",
      description: "Transform and modify requests before they reach your APIs."
    },
    {
      icon: BarChart3,
      title: "Real-time monitoring",
      description: "Monitor API performance and usage in real-time."
    },
    {
      icon: Shield,
      title: "API versioning",
      description: "Manage multiple API versions with seamless transitions."
    }
  ]
      ...
      <div className="relative z-10">
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-lg text-neutral-400 max-w-2xl mx-auto mb-8">
                Secure and scalable API management with built-in monitoring and analytics.
                Control, monitor, and optimize your API ecosystem.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="pb-24">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">API Gateway Features</h2>
        ...
        <section className="pb-24">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">API Gateway Benefits</h2>
                <p className="text-neutral-400">
                  Why developers choose our API gateway solution
                </p>
              </motion.div>
        ...
        <section className="pb-24">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-2xl font-bold text-white mb-4">Ready to Manage APIs?</h2>
              <p className="text-neutral-400 mb-6">
                Start managing your APIs with our powerful gateway solution.
              </p>
