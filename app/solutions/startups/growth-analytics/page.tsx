...
import { ArrowLeft, TrendingUp, BarChart3, Users, CheckCircle } from "lucide-react"
  ...
  const analyticsFeatures = [
    {
      ...
      description: "Track key performance indicators and growth metrics in real-time."
    },
    {
      icon: BarChart3,
      title: "User Behavior Analytics",
      description: "Understand how users interact with your product and identify opportunities."
    },
    {
      icon: Users,
      title: "Conversion Tracking",
      description: "Monitor funnel performance and optimize conversion rates."
    }
  ]
      ...
      <div className="relative z-10">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg text-neutral-400 max-w-2xl mx-auto mb-8">
                Track your key metrics with built-in analytics to make data-driven growth decisions.
                Understand your users and optimize your product for maximum growth.
              </p>
            </motion.div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-neutral-400 max-w-2xl mx-auto">
                Comprehensive analytics tools to drive your startup growth
              </p>
            </motion.div>
            ...
            <div className="max-w-4xl mx-auto">
              ...
              >
                ...
                <p className="text-neutral-400">
                  Turn data into actionable insights for sustainable growth
                </p>
              </motion.div>
        ...
        <section className="pb-24">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-2xl font-bold text-white mb-4">Start Tracking Growth</h2>
              <p className="text-neutral-400 mb-6">
                Get built-in analytics to track your metrics and make data-driven decisions.
              </p>
