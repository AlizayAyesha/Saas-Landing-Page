...
import { ArrowLeft, Users, MessageCircle, Award, CheckCircle } from "lucide-react"
  ...
  const communityFeatures = [
    {
      ...
      description: "Connect with thousands of founders, entrepreneurs, and industry experts."
    },
    {
      icon: MessageCircle,
      title: "Mentorship Program",
      description: "Access experienced advisors and mentors to guide your startup journey."
    },
    {
      icon: Award,
      title: "Exclusive Resources",
      description: "Access startup guides, templates, and resources available only to our community."
    }
  ]
      ...
      <div className="relative z-10">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg text-neutral-400 max-w-2xl mx-auto mb-8">
                Connect with mentors, access exclusive startup resources, and be part of a thriving community
                of entrepreneurs building the next generation of companies.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="pb-24">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Community Features</h2>
              <p className="text-neutral-400 max-w-2xl mx-auto">
                Everything you need to connect, learn, and grow with fellow entrepreneurs
              </p>
            </motion.div>
        ...
        <section className="pb-24">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Community Benefits</h2>
                <p className="text-neutral-400">
                  Grow your network and accelerate your startup success
                </p>
              </motion.div>
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-neutral-400 mb-6">
                Connect with fellow founders and access exclusive resources to accelerate your startup.
              </p>
