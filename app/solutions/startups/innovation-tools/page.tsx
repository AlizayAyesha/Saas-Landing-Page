...
import { ArrowLeft, Lightbulb, Cpu, Code, CheckCircle } from "lucide-react"

export default function InnovationToolsPage() {
  const innovationFeatures = [
    {
      icon: Lightbulb,
      title: "Cutting-Edge APIs",
      description: "Access to the latest technology APIs and integrations."
    },
    {
      icon: Cpu,
      title: "AI/ML Integration",
      description: "Build intelligent applications with built-in AI and ML capabilities."
    },
    {
      icon: Code,
      title: "Developer Tools",
      description: "Streamlined development workflow with modern tools and frameworks."
    }
  ]

  const benefits = [
    "Access cutting-edge APIs",
      ...
      <div className="relative z-10">
          ...
          <div className="container mx-auto px-4">
            ...
            >
              ...
              <p className="text-lg text-neutral-400 max-w-2xl mx-auto mb-8">
                Access to cutting-edge tools and APIs to build the next generation of applications.
                Stay ahead of the curve with the latest technology innovations.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="pb-24">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Innovation Features</h2>
              <p className="text-neutral-400 max-w-2xl mx-auto">
                Cutting-edge tools and technologies to power your innovation
              </p>
            </motion.div>
        ...
        <section className="pb-24">
          <div className="container mx-auto px-4">
            <div className="max-w-4xl mx-auto">
              ...
              >
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Innovation Benefits</h2>
        ...
        <section className="pb-24">
          <div className="container mx-auto px-4">
            ...
            >
              <h2 className="text-2xl font-bold text-white mb-4">Start Innovating</h2>
              <p className="text-neutral-400 mb-6">
                Access cutting-edge tools and APIs to build the next generation of applications.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/signup">
                  <button className="bg-[#00E699] hover:bg-[#00E699]/90 text-black font-medium px-8 py-4 rounded-lg transition-colors">
                    Access Innovation Tools
                  </button>
                </Link>
                <Link href="/docs">
